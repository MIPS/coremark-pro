...
COMPILER_FLAGS	= -g -O2 $(CDEFN)NDEBUG $(CDEFN)HOST_EXAMPLE_CODE=1 -DEE_SIZEOF_LONG=8 -DEE_SIZEOF_INT=4 -DEE_SIZEOF_PTR=8
...
LINKER_FLAGS	+= -lm -lpthread -Wl,--dynamic-linker=${TOOLS}/sysroot/lib/ld-${LDVER}.so -Wl,-rpath=${TOOLS}/sysroot/lib # -Wl,-rpath-link=${TOOLS}/sysroot/usr/lib
